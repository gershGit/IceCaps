...
enum component_type {TRANSFORM, PARENT, AABB_COMPONENT,
						...
						TAGS_COMPONENT,
						COLLISION, NO_TYPE};
enum system_type {RENDER_SYSTEM, RIGID_BODY_SYSTEM, COLLISION_SYSTEM, ANIMATION_SYSTEM, INPUT_SYSTEM, CLIENT_NET_SYSTEM, SERVER_NET_SYSTEM, PEER_NET_SYSTEM, SCENE_TREE_SYSTEM, NO_SYSTEM_TYPE = -1};
